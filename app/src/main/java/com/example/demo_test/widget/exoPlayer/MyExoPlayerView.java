...
public class MyExoPlayerView extends FrameLayout {
    ...
    private final MyPlayBackControlView controller;
    ...
    public MyExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.widget_my_player_view, this);
        ...
        controller = (MyPlayBackControlView) findViewById(com.google.android.exoplayer2.R.id.control);
        controller.hide();
     ...
     */
    public void setControllerVisibilityListener(MyPlayBackControlView.VisibilityListener listener) {
    ...
    public void setFullScreen(boolean isShow){
        if (null!= controller){
            controller.setFullScreenButton(isShow);
        }
    }
}
