package com.example.demo_test.widget.exoPlayer;
...
import com.example.demo_test.utils.TryExtKt;
...
public class MyPlayBackControlView extends FrameLayout {
    ...
    public interface VisibilityListener {
        ...
        void onScreenOrientationChange(boolean full);
    }
    ...
    private final ImageView playScreenFull;
    ...
    public MyPlayBackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        playScreenFull = (ImageView) findViewById(R.id.player_screen_full);
        playScreenFull.setOnClickListener(componentListener);
    ...
    private void updatePlayPauseButton() {
        ...
        playButton.setImageResource(playing ? R.drawable.mediacontroller_pause02 : R.drawable.mediacontroller_play02);
    }
    ...
    public final class ComponentListener implements ExoPlayer.EventListener,
        ...
        public void onClick(View view) {
            ...
            if (nextButton == view) {
                ...
                player.setPlayWhenReady(!player.getPlayWhenReady());
            } else if (playScreenFull == view) {
                if (visibilityListener != null) {
                    if (isFull) {
                        visibilityListener.onScreenOrientationChange(false);
                        playScreenFull.setImageResource(R.drawable.zhibo_screen_full);
                    } else {
                        visibilityListener.onScreenOrientationChange(true);
                        playScreenFull.setImageResource(R.drawable.zhibo_screen_nofull);
                    }
                    isFull = !isFull;
                }
            }
    ...
    public void setFullScreenButton(boolean visibility) {
        if (visibility) {
            playScreenFull.setVisibility(VISIBLE);
        } else {
            playScreenFull.setVisibility(GONE);
        }
